...
const RightSidebar = () => {
    ...
    <div className="bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll max-md:hidden">
      ...
      <button onClick= {()=> logout()}className="absolute bottom-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-purple-400 to-violet-600 text-sm py-2 px-6 rounded-full">
        Logout
      </button>
    </div>
  );
